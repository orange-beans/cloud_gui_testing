...
var vdev = (function () {
  ...
  V_Button = function (name) {
    ...
    //
    _getVicia = function(_vicia) {
      for (var key in _vicia) {
        if(_vicia_obj.hasOwnProperty(key)) {
          _vicia_obj[key] = _vicia[key];
        }
      }
      return _vicia_obj;
    };
