...
var Cmd_Btn = function (obj) {
  ...
  $.each(obj.f_obj["conditions"], function(idx, val_obj) {
    ...
    $temp.on('click', function () {
      ...
      console.log(lan.str_ary, lan.fuc_ary, lan.obj_ary);
    });
...
// this is a prototype of Dom_module
//
var Lan_obj = function (obj_name, obj_id, dsp_str, fuc_str, vicia_obj) {
  var
  ...
  _added_feature = {
    dsp_str  :  dsp_str,
    fuc_str  :  fuc_str,
    vicia_obj:  jQuery.extend({}, vicia_obj),
    dom      :  _dom_map.$dom,
