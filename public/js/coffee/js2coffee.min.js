...
(function() {
var Builder, Code, Node, Transformer, Typenames, Types, UnsupportedError, blockTrim, buildCoffee, exports, indent_lines, isSingleLine, ltrim, p, paren, parser, rtrim, strEscape, strRepeat, trim, truthy, unreserve, unshift, _, _ref, _ref2,
__indexOf = Array.prototype.indexOf || function(item) { for (var i = 0, l = this.length; i < l; i++) { if (i in this && this[i] === item) return i; } return -1; },
__slice = Array.prototype.slice,
...
indent_lines = function(indent, lines) {
return indent + lines.replace(/\n/g, "\n" + indent);
};
buildCoffee = function(str, opts) {
var builder, comments, indent, keep_line_numbers, l, line, minline, output, precomments, res, scriptNode, srclines, text, _i, _len, _ref3;
if (opts == null) opts = {};
str = str.replace(/\r/g, '');
str += "\n";
...
if (precomments) res.push(indent_lines(indent, precomments));
}
if (text) {
if (keep_line_numbers) text = text + "#" + srclines.join(",") + "#  ";
...
Builder.prototype.make_comment = function(comment) {
var c, line;
...
Builder.prototype.comments_not_done_to = function(lineno) {
var c, res;
res = [];
while (true) {
...
Builder.prototype.line_comments = function(linenos) {
var c, selection;
selection = (function() {
...
c = selection[_i];
_results.push(this.make_comment(c));
}
return _results;
}).call(this)).join("\n");
};
